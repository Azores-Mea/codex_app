...
public class AdminLessonActivity extends AppCompatActivity {
    ...
    private EditText lessonIdInput, subSectionIdInput;
    private Spinner sectionSpinner;

    // Title section
    private EditText titleInput, descriptionInput;

    // ✅ Helper text fields (kept)
    ...
    private void uploadData() {
        ...
        DatabaseReference sectionRef = databaseRef.child(lessonId).child(subSectionId).child(sectionType);
